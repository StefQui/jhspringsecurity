...
public class JhspringsecurityApp {

    private static final Logger log = LoggerFactory.getLogger(JhspringsecurityApp.class);

    private final Environment env;

    public JhspringsecurityApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhspringsecurity.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhspringsecurityApp.class);
